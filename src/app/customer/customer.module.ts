...
@NgModule({
  declarations: [CustomerComponent, FooterComponent, MerchantRegisterComponent,
    ...
    TrackOrderComponent, AddToCartComponent, AddToCartComponent, CartTableCheckoutComponent, ShipperRegisterComponent, MerchantComponent, FoodCardComponent, JoinUsComponent],
  exports: [
    FooterComponent
  ],
